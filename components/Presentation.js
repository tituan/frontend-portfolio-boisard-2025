        ...
        <div className="presentation__content">
          <div className="presentation__wrapper">
            ...
            <p className="presentation__content__text">
              Je suis heureux de me présenter en tant que développeur web front-end, fort de cinq années d&rsquo;expérience dans un domaine aussi stimulant qu&rsquo;en perpétuelle évolution. Cette période m&rsquo;a permis de contribuer à une grande variété de projets, de consolider mes compétences techniques et de cultiver une véritable passion pour la création d&rsquo;interfaces à la fois esthétiques et performantes.
            </p>
            <p className="presentation__content__text">
